...
INSERT INTO `schooldb`.`client` (`name`, `address`, `email`, `age`) VALUES ('andr', '098', 'bjg798@yahoo.com', '51'),('Mary', '123', 'aMary@yahoo.com', '15');
INSERT INTO `schooldb`.`product` (`name`,`stock`, `price`) VALUES ('lapte',123, 098),('sare',321, 123);
INSERT INTO `schooldb`.`order` (`quantity`,`Client`, `Product`) VALUES ('4','2', 1);
INSERT INTO `schooldb`.`bill` (`quantity`, `pret_total`, `Client`, `Product`) VALUES ('4', '392', '2', '1');
